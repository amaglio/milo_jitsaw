...
<head>
    ...
    <link rel="canonical" href="https://www.milo.cl/productos/">
    <link rel="shortlink" href="https://www.milo.cl/?p=3558">
    <link rel="alternate" type="application/json+oembed"
        href="https://www.milo.cl/wp-json/oembed/1.0/embed?url=https%3A%2F%2Fwww.milo.cl%2Fproductos%2F">
    <link rel="alternate" type="text/xml+oembed"
        href="https://www.milo.cl/wp-json/oembed/1.0/embed?url=https%3A%2F%2Fwww.milo.cl%2Fproductos%2F&amp;format=xml">
    ...
    <style type="text/css">
        #divPrincipal {
            background-image: url('/wp-content/uploads/2020/02/portada_productos_MILO_con_logo.jpg');
        }
...
<body class="page-template-default page page-id-3558 custom-background mega-menu-main-menu  sidebar-right">
                ...
                <div class="container">
                    ...
                    <div id="mega-menu-wrap-main_menu" class="mega-menu-wrap">
                        ...
                        <ul id="mega-menu-main_menu" class="mega-menu max-mega-menu mega-menu-horizontal"
                            ...
                            <li class="mega-menu-item mega-menu-item-type-custom mega-menu-item-object-custom mega-current-menu-item mega-align-bottom-left mega-menu-flyout mega-menu-item-3545"
                                        ...
                                        <div class="detailProduct">
                                            ...
                                            <div class="detailText">
                                                <p>Para comenzar el día a toda energía, dale a tus hijos un <span
                                                    ...
                                                    MILO.</p>
                                                <p> <a href="https://milo.cl/MILO-TRADICIONAL.pdf"
                                        ...
                                        <div class="detailProduct">
                                            ...
                                            <div class="detailText">
                                                <p>Complemento ideal para la <span class="underlined">colación</span> de
                                                    tus hijos.</p>
                                                <p> <a href="https://milo.cl/MILO-EN-CAJITA.pdf"
                                                        target="_blank">Descargar ficha</a>
                                                </p>
                                            </div>
                                            <p></p>
    ...
    <div id="mega-menu-wrap-main_menu" class="mega-menu-wrap">
        ...
        <ul id="mega-menu-main_menu" class="mega-menu max-mega-menu mega-menu-horizontal" data-event="hover_intent"
            ...
            <li class="mega-menu-item mega-menu-item-type-custom mega-menu-item-object-custom mega-menu-item-home mega-align-bottom-left mega-menu-flyout mega-menu-item-3725"
                id="mega-menu-item-3725"><a class="mega-menu-link" href="https://www.milo.cl/" tabindex="0">Inicio</a>
            </li>
            <li class="mega-menu-item mega-menu-item-type-custom mega-menu-item-object-custom mega-current-menu-item mega-align-bottom-left mega-menu-flyout mega-menu-item-3545"
                id="mega-menu-item-3545"><a class="mega-menu-link" href="https://www.milo.cl/productos"
                    tabindex="0">Productos</a></li>
            <li class="mega-menu-item mega-menu-item-type-custom mega-menu-item-object-custom mega-align-bottom-left mega-menu-flyout mega-menu-item-3546"
                id="mega-menu-item-3546"><a class="mega-menu-link" href="https://www.milo.cl/nutricion"
                    tabindex="0">Nutrición</a></li>
            <li class="mega-menu-item mega-menu-item-type-custom mega-menu-item-object-custom mega-align-bottom-left mega-menu-flyout mega-menu-item-3547"
                id="mega-menu-item-3547"><a class="mega-menu-link" href="https://www.milo.cl/comunidad"
                    tabindex="0">Comunidad</a></li>
        </ul>
    </div>
